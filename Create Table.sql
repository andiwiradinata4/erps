...
GO
/****** Object:  Table [dbo].[mstModuleIDARAP]    Script Date: 07/09/2023 17:38:51 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE TABLE [dbo].[mstModuleIDARAP](
	[ID] [int] NOT NULL CONSTRAINT [DF_mstModuleIDARAP_ID]  DEFAULT ((0)),
	[Code] [varchar](100) NOT NULL CONSTRAINT [DF_mstModuleIDARAP_Code]  DEFAULT (''),
	[Name] [varchar](100) NOT NULL CONSTRAINT [DF_mstModuleIDARAP_Name]  DEFAULT (''),
	[StatusID] [int] NOT NULL CONSTRAINT [DF_mstModuleIDARAP_StatusID]  DEFAULT ((0)),
	[CreatedBy] [varchar](20) NOT NULL CONSTRAINT [DF_mstModuleIDARAP_CreatedBy]  DEFAULT ('SYSTEM'),
	[CreatedDate] [datetime] NOT NULL CONSTRAINT [DF_mstModuleIDARAP_CreatedDate]  DEFAULT (getdate()),
	[LogBy] [varchar](20) NOT NULL CONSTRAINT [DF_mstModuleIDARAP_LogBy]  DEFAULT ('SYSTEM'),
	[LogDate] [datetime] NOT NULL CONSTRAINT [DF_mstModuleIDARAP_LogDate]  DEFAULT (getdate()),
	[LogInc] [int] NULL CONSTRAINT [DF_mstModuleIDARAP_LogInc]  DEFAULT ((0)),
...
INSERT INTO mstModuleIDARAP VALUES (1, 'PB', 'SALDO PEMBELIAN', 1, 'SYSTEM',GETDATE(), 'SYSTEM',GETDATE(), 0)
INSERT INTO mstModuleIDARAP VALUES (2, 'PDM', 'DP MANUAL PEMBELIAN', 1, 'SYSTEM',GETDATE(), 'SYSTEM',GETDATE(), 0)
INSERT INTO mstModuleIDARAP VALUES (3, 'PDP', 'DP PEMBELIAN', 1, 'SYSTEM',GETDATE(), 'SYSTEM',GETDATE(), 0)
INSERT INTO mstModuleIDARAP VALUES (4, 'PI', 'PEMBAYARAN', 1, 'SYSTEM',GETDATE(), 'SYSTEM',GETDATE(), 0)
INSERT INTO mstModuleIDARAP VALUES (5, 'CDP', 'DP PEMOTONGAN', 1, 'SYSTEM',GETDATE(), 'SYSTEM',GETDATE(), 0)
INSERT INTO mstModuleIDARAP VALUES (6, 'CI', 'PEMBAYARAN PEMOTONGAN', 1, 'SYSTEM',GETDATE(), 'SYSTEM',GETDATE(), 0)
INSERT INTO mstModuleIDARAP VALUES (7, 'TDP', 'DP TRANSPORT', 1, 'SYSTEM',GETDATE(), 'SYSTEM',GETDATE(), 0)
INSERT INTO mstModuleIDARAP VALUES (8, 'TI', 'PEMBAYARAN TRANSPORT', 1, 'SYSTEM',GETDATE(), 'SYSTEM',GETDATE(), 0)

INSERT INTO mstModuleIDARAP VALUES (9, 'SB', 'SALDO PENJUALAN', 1, 'SYSTEM',GETDATE(), 'SYSTEM',GETDATE(), 0)
INSERT INTO mstModuleIDARAP VALUES (10, 'SDM', 'DP MANUAL PENJUALAN', 1, 'SYSTEM',GETDATE(), 'SYSTEM',GETDATE(), 0)
INSERT INTO mstModuleIDARAP VALUES (11, 'SDP', 'DP PENJUALAN', 1, 'SYSTEM',GETDATE(), 'SYSTEM',GETDATE(), 0)
INSERT INTO mstModuleIDARAP VALUES (12, 'SI', 'PELUNASAN', 1, 'SYSTEM',GETDATE(), 'SYSTEM',GETDATE(), 0)
