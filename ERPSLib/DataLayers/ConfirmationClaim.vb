        ...
        Public Shared Sub CalculateTotalUsedReceivePaymentVer02(ByRef sqlCon As SqlConnection, ByRef sqlTrans As SqlTransaction,
            ...
            With sqlCmdExecute
                ...
                .CommandText =
                    ...
                    "		FROM traConfirmationClaimDet TDD " & vbNewLine &
                    "		WHERE 	" & vbNewLine &
                    "			TDD.ConfirmationClaimID=@ID 	" & vbNewLine &
                    "	), " & vbNewLine &
...
"	ConfirmationClaimID=@ConfirmationClaimID " & vbNewLine
        ...
        Public Shared Sub CalculateTotalUsedReceiveItemPaymentPurchaseVer02(ByRef sqlCon As SqlConnection, ByRef sqlTrans As SqlTransaction,
            ...
            With sqlCmdExecute
                ...
                .CommandType = CommandType.Text
                .CommandText =
                    "UPDATE traConfirmationClaimDet SET 	" & vbNewLine &
                ...
                .Parameters.Add("@Modules", SqlDbType.VarChar, 250).Value = VO.AccountReceivable.ReceivePaymentClaimPurchase
            End With
            Try
                SQL.ExecuteNonQuery(sqlCmdExecute, sqlTrans)
            Catch ex As Exception
        ...
        Public Shared Sub CalculateTotalUsedReceiveItemPaymentSalesVer02(ByRef sqlCon As SqlConnection, ByRef sqlTrans As SqlTransaction,
                                                                         ByVal strDetailID As String)
            Dim sqlCmdExecute As New SqlCommand
            With sqlCmdExecute
                .Connection = sqlCon
                ...
                .Parameters.Add("@ReferencesDetailID", SqlDbType.VarChar, 100).Value = strDetailID
                .Parameters.Add("@Modules", SqlDbType.VarChar, 250).Value = VO.AccountPayable.ReceivePaymentClaimSales
            End With
            Try
                SQL.ExecuteNonQuery(sqlCmdExecute, sqlTrans)
            Catch ex As Exception
