...
"
SELECT 
	A.ID, A.ClaimID, A.ReferencesDetailID, A.ItemID, A.Quantity, A.Weight, A.TotalWeight, 
...
"
        ...
        Public Shared Sub SaveData(ByRef sqlCon As SqlConnection, ByRef sqlTrans As SqlTransaction, ByVal bolNew as Boolean, ByVal clsData As VO.ClaimDet)
            Dim sqlcmdExecute As New SqlCommand
            With sqlcmdExecute
                .Connection = sqlCon
                .Transaction = sqlTrans
                If bolNew Then
                    .CommandText = 
"
INSERT INTO traClaimDet
	(ID, ClaimID, ReferencesDetailID, ItemID, Quantity, Weight, TotalWeight, 
...
"
                Else
                    .CommandText = 
"
UPDATE traClaimDet SET 
	ClaimID=@ClaimID, 
	ReferencesDetailID=@ReferencesDetailID, 
	ItemID=@ItemID, 
	Quantity=@Quantity, 
	Weight=@Weight, 
...
"
        ...
        Public Shared Function GetDetail(ByRef sqlCon As SqlConnection, ByRef sqlTrans As SqlTransaction, ByVal strID As String) As VO.ClaimDet
            Dim sqlcmdExecute As New SqlCommand, sqlrdData As SqlDataReader = Nothing
            Dim voReturn As New VO.ClaimDet
            Try
                With sqlcmdExecute
                    .Connection = sqlCon 
                    .Transaction = sqlTrans 
