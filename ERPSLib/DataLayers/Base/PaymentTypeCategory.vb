Namespace DL
    Public Class PaymentTypeCategory
        ...
        Public Shared Function ListData(ByRef sqlCon As SqlConnection, ByRef sqlTrans As SqlTransaction) As DataTable
            ...
            With sqlcmdExecute
                ...
                .CommandText = _
                   ...
                   "FROM mstPaymentTypeCategory A " & vbNewLine & _
        ...
        Public Shared Sub SaveData(ByRef sqlCon As SqlConnection, ByRef sqlTrans As SqlTransaction,
                                   ByVal bolNew As Boolean, ByVal clsData As VO.PaymentTypeCategory)
            Dim sqlcmdExecute As New SqlCommand
            With sqlcmdExecute
                .Connection = sqlCon
                .Transaction = sqlTrans
                ...
                If bolNew Then
                    .CommandText = _
                       "INSERT INTO mstPaymentTypeCategory " & vbNewLine & _
                ...
                Else
                    .CommandText = _
                    "UPDATE mstPaymentTypeCategory SET " & vbNewLine & _
        ...
        Public Shared Function GetDetail(ByRef sqlCon As SqlConnection, ByRef sqlTrans As SqlTransaction, ByVal intID As Integer) As VO.PaymentTypeCategory
            Dim sqlcmdExecute As New SqlCommand, sqlrdData As SqlDataReader = Nothing
            Dim voReturn As New VO.PaymentTypeCategory
            Try
                With sqlcmdExecute
                    .Connection = sqlCon
                    .Transaction = sqlTrans
        ...
        Public Shared Sub DeleteData(ByRef sqlCon As SqlConnection, ByRef sqlTrans As SqlTransaction, ByVal intID As Integer)
            ...
            With sqlcmdExecute
                ...
                .CommandType = CommandType.Text
                .CommandText = _
                    "UPDATE mstPaymentTypeCategory " & vbNewLine & _
        ...
        Public Shared Sub DeleteDataAll(ByRef sqlCon As SqlConnection, ByRef sqlTrans As SqlTransaction)
            ...
            With sqlcmdExecute
                ...
                .CommandType = CommandType.Text
                .CommandText = _
                    "DELETE mstPaymentTypeCategory " & vbNewLine
            ...
            Try
                With sqlcmdExecute
                    ...
                    .CommandText = _
                        ...
                        "FROM mstPaymentTypeCategory " & vbNewLine
                End With
                sqlrdData = SQL.ExecuteReader(sqlCon, sqlcmdExecute)
                With sqlrdData
                    If .HasRows Then
            ...
            Try
                With sqlcmdExecute
                    ...
                    .CommandText = _
                        "SELECT TOP 1 " & vbNewLine & _
                        "   ID " & vbNewLine & _
                        "FROM mstPaymentTypeCategory " & vbNewLine & _
                        "WHERE  " & vbNewLine & _
                        "   ID=@ID " & vbNewLine
