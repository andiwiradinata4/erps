...
"
SELECT 
	A.ID, A.ClaimID, A.Status, A.StatusBy, A.StatusDate, A.Remarks
FROM traClaimStatus A
WHERE 
	1=1 
"
        ...
        Public Shared Sub SaveData(ByRef sqlCon As SqlConnection, ByRef sqlTrans As SqlTransaction, ByVal bolNew as Boolean, ByVal clsData As VO.ClaimStatus)
            Dim sqlcmdExecute As New SqlCommand
            With sqlcmdExecute
                .Connection = sqlCon
                .Transaction = sqlTrans
                If bolNew Then
                    .CommandText = 
"
INSERT INTO traClaimStatus
	(ID, ClaimID, StatusBy, StatusDate, Remarks)
VALUES 
	(@ID, @ClaimID, @LogBy, GETDATE(), @Remarks)
"
                Else
                    .CommandText = 
"
UPDATE traClaimStatus SET 
	ClaimID=@ClaimID, 
	Status=@Status, 
	StatusBy=@StatusBy, 
...
"
        ...
        Public Shared Function GetDetail(ByRef sqlCon As SqlConnection, ByRef sqlTrans As SqlTransaction, ByVal strID As String) As VO.ClaimStatus
            Dim sqlcmdExecute As New SqlCommand, sqlrdData As SqlDataReader = Nothing
            Dim voReturn As New VO.ClaimStatus
            Try
                With sqlcmdExecute
                    .Connection = sqlCon 
                    .Transaction = sqlTrans 
