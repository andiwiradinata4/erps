Namespace DL
    Public Class DeliveryLocation
        ...
        Public Shared Function ListData(ByRef sqlCon As SqlConnection, ByRef sqlTrans As SqlTransaction) As DataTable
            ...
            With sqlCmdExecute
                ...
                .CommandText = _
                    ...
                    "FROM mstDeliveryLocation A " & vbNewLine & _
        ...
        Public Shared Sub SaveData(ByRef sqlCon As SqlConnection, ByRef sqlTrans As SqlTransaction,
                                   ByVal bolNew As Boolean, ByVal clsData As VO.DeliveryLocation)
            Dim sqlCmdExecute As New SqlCommand
            With sqlCmdExecute
                .Connection = sqlCon
                .Transaction = sqlTrans
                ...
                If bolNew Then
                    .CommandText = _
                        "INSERT INTO mstDeliveryLocation " & vbNewLine & _
                ...
                Else
                    .CommandText = _
                        "UPDATE mstDeliveryLocation SET " & vbNewLine & _
        ...
        Public Shared Function GetDetail(ByRef sqlCon As SqlConnection, ByRef sqlTrans As SqlTransaction,
                                         ByVal intID As Integer) As VO.DeliveryLocation
            Dim sqlCmdExecute As New SqlCommand, sqlrdData As SqlDataReader = Nothing
            Dim voReturn As New VO.DeliveryLocation
            Try
                With sqlCmdExecute
                    .Connection = sqlCon
                    .Transaction = sqlTrans
        ...
        Public Shared Sub DeleteData(ByRef sqlCon As SqlConnection, ByRef sqlTrans As SqlTransaction, ByVal intID As Integer)
            ...
            With sqlcmdExecute
                ...
                .CommandType = CommandType.Text
                .CommandText = _
                    "UPDATE mstDeliveryLocation " & vbNewLine & _
        ...
        Public Shared Sub DeleteDataAll(ByRef sqlCon As SqlConnection, ByRef sqlTrans As SqlTransaction)
            ...
            With sqlcmdExecute
                ...
                .CommandType = CommandType.Text
                .CommandText = _
                    "DELETE mstDeliveryLocation " & vbNewLine
            ...
            Try
                With sqlcmdExecute
                    ...
                    .CommandText = _
                        ...
                        "FROM mstDeliveryLocation " & vbNewLine
                End With
                sqlrdData = SQL.ExecuteReader(sqlCon, sqlcmdExecute)
                With sqlrdData
                    If .HasRows Then
            ...
            Try
                With sqlcmdExecute
                    ...
                    .CommandText = _
                        "SELECT TOP 1 " & vbNewLine & _
                        "   ID " & vbNewLine & _
                        "FROM mstDeliveryLocation " & vbNewLine & _
                        "WHERE  " & vbNewLine & _
                        "   Description=@Description " & vbNewLine & _
                        "   AND ID<>@ID " & vbNewLine
