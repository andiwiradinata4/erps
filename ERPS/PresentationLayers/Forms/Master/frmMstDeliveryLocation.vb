Public Class frmMstDeliveryLocation
    ...
    Private Sub prvQuery()
        Try
            grdMain.DataSource = BL.DeliveryLocation.ListData()
    ...
    Private Sub prvNew()
        Dim frmDetail As New frmMstDeliveryLocationDet
        With frmDetail
            .pubIsNew = True
    ...
    Private Sub prvDelete()
        ...
        Try
            BL.DeliveryLocation.DeleteData(grdView.GetRowCellValue(intPos, "ID"))
...
#Region "Form Handle"
    ...
    Private Sub frmMstDeliveryLocation_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmMstDeliveryLocation_Load(sender As Object, e As EventArgs) Handles MyBase.Load
