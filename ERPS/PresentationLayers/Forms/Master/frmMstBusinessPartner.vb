Public Class frmMstBusinessPartner
    ...
    Private Sub prvUserAccess()
        With ToolBar.Buttons
            ...
            .Item(cBankAccount).Visible = BL.UserAccess.IsCanAccess(ERPSLib.UI.usUserApp.UserID, ERPSLib.UI.usUserApp.ProgramID, VO.Modules.Values.MasterBusinessPartner, VO.Access.Values.BankInfo)
        End With
    End Sub
