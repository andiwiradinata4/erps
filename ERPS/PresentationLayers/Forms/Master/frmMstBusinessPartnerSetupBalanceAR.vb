...
Public Class frmMstBusinessPartnerSetupBalanceAR
...
#End Region
    ...
    Private Sub prvSave()
        ...
        For Each dr As DataRow In dtItem.Rows
            clsDataDetailAll.Add(New VO.BusinessPartnerARBalance With
                                 {
...
#Region "Form Handle"
    ...
    Private Sub frmMstBusinessPartnerSetupBalanceAR_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmMstBusinessPartnerSetupBalanceAR_Load(sender As Object, e As EventArgs) Handles MyBase.Load
