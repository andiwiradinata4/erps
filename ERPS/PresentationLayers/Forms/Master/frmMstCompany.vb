Public Class frmMstCompany
    ...
    Private Sub prvSetGrid()
        ...
        UI.usForm.SetGrid(grdView, "Address2", "Alamat 2", 100, UI.usDefGrid.gString)
        UI.usForm.SetGrid(grdView, "Country", "Negara", 100, UI.usDefGrid.gString)
        UI.usForm.SetGrid(grdView, "Province", "Provinsi", 100, UI.usDefGrid.gString)
    ...
    Private Sub prvUserAccess()
        With ToolBar.Buttons
            .Item(cNew).Visible = BL.UserAccess.IsCanAccess(ERPSLib.UI.usUserApp.UserID, ERPSLib.UI.usUserApp.ProgramID, VO.Modules.Values.MasterProgram, VO.Access.Values.NewAccess)
            .Item(cDelete).Visible = BL.UserAccess.IsCanAccess(ERPSLib.UI.usUserApp.UserID, ERPSLib.UI.usUserApp.ProgramID, VO.Modules.Values.MasterProgram, VO.Access.Values.DeleteAccess)
        End With
    End Sub
