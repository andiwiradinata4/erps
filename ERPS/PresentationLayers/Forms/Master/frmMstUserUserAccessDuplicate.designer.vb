...
Partial Class frmMstUserUserAccessDuplicate
    ...
    Private Sub InitializeComponent()
        ...
        Me.txtNewUserID = New ERPS.usTextBox()
        Me.txtBaseUserID = New ERPS.usTextBox()
    ...
    Friend WithEvents txtBaseUserID As ERPS.usTextBox
    Friend WithEvents Label2 As System.Windows.Forms.Label
    Friend WithEvents txtNewUserID As ERPS.usTextBox
