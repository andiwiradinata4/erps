Public Class frmMstPaymentTypeCategory
    ...
    Private Sub prvQuery()
        Try
            grdMain.DataSource = BL.PaymentTypeCategory.ListData()
    ...
    Private Sub prvNew()
        Dim frmDetail As New frmMstPaymentTypeCategoryDet
        With frmDetail
            .pubIsNew = True
    ...
    Private Sub prvDelete()
        ...
        Try
            BL.PaymentTypeCategory.DeleteData(grdView.GetRowCellValue(intPos, "ID"))
    ...
    Private Sub prvUserAccess()
        With ToolBar.Buttons
            .Item(cNew).Visible = BL.UserAccess.IsCanAccess(ERPSLib.UI.usUserApp.UserID, ERPSLib.UI.usUserApp.ProgramID, VO.Modules.Values.MasterPaymentTypeCategory, VO.Access.Values.NewAccess)
            .Item(cDelete).Visible = BL.UserAccess.IsCanAccess(ERPSLib.UI.usUserApp.UserID, ERPSLib.UI.usUserApp.ProgramID, VO.Modules.Values.MasterPaymentTypeCategory, VO.Access.Values.DeleteAccess)
        End With
    End Sub

#Region "Form Handle"

    Private Sub frmMstPaymentTypeCategory_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form ini?") Then Me.Close()
        End If
    End Sub

    Private Sub frmMstPaymentTypeCategory_Load(sender As Object, e As EventArgs) Handles MyBase.Load
