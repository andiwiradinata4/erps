Public Class frmMstPaymentType
    ...
    Private Sub prvSetGrid()
        ...
        UI.usForm.SetGrid(grdView, "PaymentTypeCategoryID", "PaymentTypeCategoryID", 100, UI.usDefGrid.gIntNum, False)
        UI.usForm.SetGrid(grdView, "PaymentTypeCategoryName", "Kategori", 100, UI.usDefGrid.gString)
    ...
    Private Sub prvQuery()
        Try
            grdMain.DataSource = BL.PaymentType.ListData()
    ...
    Private Sub prvNew()
        Dim frmDetail As New frmMstPaymentTypeDet
        With frmDetail
            .pubIsNew = True
    ...
    Private Sub prvDelete()
        ...
        Try
            BL.PaymentType.DeleteData(grdView.GetRowCellValue(intPos, "ID"))
    ...
    Private Sub prvUserAccess()
        With ToolBar.Buttons
            .Item(cNew).Visible = BL.UserAccess.IsCanAccess(ERPSLib.UI.usUserApp.UserID, ERPSLib.UI.usUserApp.ProgramID, VO.Modules.Values.MasterPaymentType, VO.Access.Values.NewAccess)
            .Item(cDelete).Visible = BL.UserAccess.IsCanAccess(ERPSLib.UI.usUserApp.UserID, ERPSLib.UI.usUserApp.ProgramID, VO.Modules.Values.MasterPaymentType, VO.Access.Values.DeleteAccess)
        End With
    End Sub

#Region "Form Handle"

    Private Sub frmMstPaymentType_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form ini?") Then Me.Close()
        End If
    End Sub

    Private Sub frmMstPaymentType_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub grdView_RowStyle(sender As Object, e As DevExpress.XtraGrid.Views.Grid.RowStyleEventArgs) Handles grdView.RowStyle
        ...
        If (e.RowHandle >= 0) Then
            Dim intStatusID As Integer = View.GetRowCellDisplayText(e.RowHandle, View.Columns("StatusID"))
