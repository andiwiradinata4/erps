...
#End Region
    ...
    Private Sub prvFillForm()
        ...
        Try
            ...
            Else
                ...
                chkIsFreePPN.Checked = clsData.IsFreePPN
                txtPPH.Value = clsData.PPH
                chkIsFreePPH.Checked = clsData.IsFreePPH
    ...
    Private Sub prvSave()
        ...
        clsData.IsFreePPN = chkIsFreePPN.Checked
        clsData.PPH = txtPPH.Value
        clsData.IsFreePPH = chkIsFreePPH.Checked
    ...
    Private Sub prvClear()
        ...
        txtPPN.Value = 0
        chkIsFreePPN.Checked = False
        txtPPH.Value = 0
        chkIsFreePPH.Checked = False
        txtRemarks.Text = ""
    ...
    Private Sub prvUserAccess()
        ToolBar.Buttons(cSave).Visible = BL.UserAccess.IsCanAccess(ERPSLib.UI.usUserApp.UserID, ERPSLib.UI.usUserApp.ProgramID, VO.Modules.Value.MasterBusinessPartner, IIf(pubIsNew, VO.Access.Value.NewAccess, VO.Access.Value.EditAccess))
    End Sub
