...
#End Region
    ...
    Private Sub prvQuery()
        ...
        Try
            dtData = BL.PurchaseOrder.ListDataDetailOutstandingSalesConfirmationOrder(clsCS.ProgramID, clsCS.CompanyID)
...
#Region "Form Handle"
    ...
    Private Sub frmTraSalesConfirmationOrderDetItemPO_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmTraSalesConfirmationOrderDetItemPO_Load(sender As Object, e As EventArgs) Handles MyBase.Load
