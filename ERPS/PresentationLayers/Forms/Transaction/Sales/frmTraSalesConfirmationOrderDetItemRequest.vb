...
#Region "Properties"
    ...
    Private frmParent As frmTraSalesConfirmationOrderDetItem
...
#End Region
    ...
    Private Sub prvQuery()
        ...
        Try
            dtData = BL.OrderRequest.ListDataDetailOutstandingSalesConfirmationOrder(clsCS.ProgramID, clsCS.CompanyID, intBPID)
...
#Region "Form Handle"
    ...
    Private Sub frmTraSalesConfirmationOrderDetItemRequest_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmTraSalesConfirmationOrderDetItemRequest_Load(sender As Object, e As EventArgs) Handles MyBase.Load
