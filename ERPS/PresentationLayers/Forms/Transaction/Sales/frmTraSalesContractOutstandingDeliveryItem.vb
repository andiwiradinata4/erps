...
Public Class frmTraSalesContractOutstandingDeliveryItem
...
#Region "Form Handle"
    ...
    Private Sub frmTraSalesContractOutstandingDeliveryItem_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmTraSalesContractOutstandingDeliveryItem_Load(sender As Object, e As EventArgs) Handles MyBase.Load
