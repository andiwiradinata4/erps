...
Public Class frmTraSalesContractDetVer2
...
#End Region
    ...
    Private Sub prvFillCombo()
        Try
            UI.usForm.FillComboBox(cboStatus, BL.StatusModules.ListDataByModulesID(VO.Modules.Value.TransactionSalesSalesContract), "StatusID", "StatusName")
    ...
    Private Sub prvUserAccess()
        ToolBar.Buttons(cSave).Visible = BL.UserAccess.IsCanAccess(ERPSLib.UI.usUserApp.UserID, ERPSLib.UI.usUserApp.ProgramID, VO.Modules.Value.TransactionSalesSalesContract, IIf(pubIsNew, VO.Access.Value.NewAccess, VO.Access.Value.EditAccess))
    End Sub
...
#Region "Item Handle"
    ...
    Private Sub prvAddItem()
        ...
        Dim frmDetail As New frmTraSalesContractDetItemVer2
        With frmDetail
            .pubIsNew = True
...
#Region "Form Handle"
    ...
    Private Sub frmTraSalesContractDetVer2_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmTraSalesContractDetVer2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
