...
Public Class frmTraSalesContractOutstandingPOTransport
...
#End Region
    ...
    Private Sub prvQuery()
        ...
        Try
            dtData = BL.SalesContract.ListDataOustandingPOTransport(clsCS.ProgramID, clsCS.CompanyID, intBPID)
...
#Region "Form Handle"
    ...
    Private Sub frmTraSalesContractOutstandingPOTransport_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmTraSalesContractOutstandingPOTransport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
