Public Class frmTraOrderRequestOutstandingDelivery
...
#Region "Form Handle"
    ...
    Private Sub frmTraOrderRequestOutstandingDelivery_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmTraOrderRequestOutstandingDelivery_Load(sender As Object, e As EventArgs) Handles MyBase.Load
