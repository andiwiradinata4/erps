...
Public Class frmTraSalesConfirmationOrder

    Private intPos As Integer = 0
    Private clsData As New VO.SalesConfirmationOrder
    ...
    Private Const _
       ...
       cSep2 As Byte = 8, cPrint As Byte = 9, cExportExcel As Byte = 10, cSep3 As Byte = 11,
    ...
    Private Sub prvFillCombo()
        Try
            Dim dtData As DataTable = BL.StatusModules.ListDataByModulesID(VO.Modules.Value.TransactionSalesConfirmationOrder)
            Dim dr As DataRow
            dr = dtData.NewRow
            With dr
                .BeginEdit()
    ...
    Private Sub prvQuery()
        ...
        Try
            dtData = BL.SalesConfirmationOrder.ListData(intProgramID, intCompanyID, dtpDateFrom.Value.Date, dtpDateTo.Value.Date, cboStatus.SelectedValue)
    ...
    Private Function prvGetData() As VO.SalesConfirmationOrder
        Dim clsReturn As New VO.SalesConfirmationOrder
    ...
    Private Sub prvNew()
        prvResetProgressBar()
        Dim frmDetail As New frmTraSalesConfirmationOrderDet
        With frmDetail
            .pubIsNew = True
            .pubCS = prvGetCS()
    ...
    Private Sub prvDelete()
        ...
        Try
            BL.SalesConfirmationOrder.DeleteData(clsData.ID, clsData.Remarks)
            pgMain.Value = 100
    ...
    Private Sub prvSubmit()
        ...
        Try
            BL.SalesConfirmationOrder.Submit(clsData.ID, "")
            pgMain.Value = 100
    ...
    Private Sub prvCancelSubmit()
        ...
        Try
            BL.SalesConfirmationOrder.Unsubmit(clsData.ID, clsData.Remarks)
            pgMain.Value = 100
    ...
    Private Sub prvApprove()
        ...
        clsData = prvGetData()
        clsData.LogBy = ERPSLib.UI.usUserApp.UserID
        If Not UI.usForm.frmAskQuestion("Approve Nomor " & clsData.CONumber & "?") Then Exit Sub

        Me.Cursor = Cursors.WaitCursor
        pgMain.Value = 40

        Try
            BL.SalesConfirmationOrder.Approve(clsData.ID, "")
            pgMain.Value = 100
    ...
    Private Sub prvCancelApprove()
        ...
        clsData = prvGetData()
        clsData.LogBy = ERPSLib.UI.usUserApp.UserID
        If Not UI.usForm.frmAskQuestion("Batal Approve Nomor " & clsData.CONumber & "?") Then Exit Sub
        ...
        Try
            BL.SalesConfirmationOrder.Unapprove(clsData.ID, clsData.Remarks)
            pgMain.Value = 100
...
#Region "Form Handle"
    ...
    Private Sub frmTraSalesConfirmationOrder_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmTraSalesConfirmationOrder_Load(sender As Object, e As EventArgs) Handles MyBase.Load
