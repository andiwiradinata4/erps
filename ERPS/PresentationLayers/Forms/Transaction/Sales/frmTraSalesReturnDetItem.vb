Public Class frmTraSalesReturnDetItem

#Region "Property"

    Private frmParent As frmTraSalesReturnDet
    Private bolIsNew As Boolean = False
    Private strID As String = ""
    Private strDeliveryDetailID As String = ""
    ...
    Private Sub prvFillForm()
        ...
        Try
            ...
            Else
                ...
                strDeliveryDetailID = drSelectedItem.Item("DeliveryDetailID")
    ...
    Private Sub prvSave()
        ...
        If bolIsNew Then
            ...
            With drItem
                ...
                .Item("DeliveryDetailID") = strDeliveryDetailID
    ...
    Private Sub prvChooseItem()
        ...
        With frmDetail
            ...
            If .pubIsLookupGet Then
                strDeliveryDetailID = .pubLUdtRow.Item("ID")
...
#Region "Form Handle"
    ...
    Private Sub frmTraSalesReturnDetItem_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmTraSalesReturnDetItem_Load(sender As Object, e As EventArgs) Handles MyBase.Load
