...
Public Class frmTraDeliveryDetItemTransportOutstanding

#Region "Property"

    Private intPos As Integer = 0
    Private frmParent As frmTraDeliveryDetItemTransport
...
#End Region
    ...
    Private Sub prvQuery()
        ...
        Try
            Dim dtData As DataTable = BL.PurchaseOrderTransport.ListDataDetailOutstandingDelivery(clsCS.ProgramID, clsCS.CompanyID, strSCDetailID)
...
#Region "Form Handle"
    ...
    Private Sub frmTraDeliveryDetItemTransportOutstanding_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmTraDeliveryDetItemTransportOutstanding_Load(sender As Object, e As EventArgs) Handles MyBase.Load
