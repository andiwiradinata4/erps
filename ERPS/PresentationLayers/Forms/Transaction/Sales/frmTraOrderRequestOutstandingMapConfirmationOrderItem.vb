...
#Region "Property"
    ...
    Private frmParent As frmTraOrderRequestMapConfirmationOrderDetItem
...
#End Region
    ...
    Private Sub prvQuery()
        ...
        Try
            Dim dtData As DataTable = BL.ConfirmationOrder.ListDataDetailOutstandingOrderRequest(clsCS.ProgramID, clsCS.CompanyID)
...
#Region "Form Handle"
    ...
    Private Sub frmTraOrderRequestOutstandingMapConfirmationOrderItem_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmTraOrderRequestOutstandingMapConfirmationOrderItem_Load(sender As Object, e As EventArgs) Handles MyBase.Load
