...
#End Region
    ...
    Private Sub prvQuery()
        ...
        Try
            dtData = BL.OrderRequest.ListDataDetailOutstandingMapConfirmationOrder(clsCS.ProgramID, clsCS.CompanyID, strOrderRequestID)
...
#Region "Form Handle"
    ...
    Private Sub frmTraOrderRequestOutstandingMapConfirmationOrder_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmTraOrderRequestOutstandingMapConfirmationOrder_Load(sender As Object, e As EventArgs) Handles MyBase.Load
