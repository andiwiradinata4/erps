Public Class frmTraConfirmationClaimOutstandingClaimItem

#Region "Properties"

    Private frmParent As frmTraConfirmationClaimDetItem
...
#End Region
    ...
    Private Sub prvSetGrid()
        ...
        UI.usForm.SetGrid(grdView, "UnitPrice", "Harga [Klaim]", 100, UI.usDefGrid.gReal4Num)
        ...
        UI.usForm.SetGrid(grdView, "TotalPrice", "Total Harga [Klaim]", 100, UI.usDefGrid.gReal2Num)
        UI.usForm.SetGrid(grdView, "UnitPriceProduct", "Harga [Barang]", 100, UI.usDefGrid.gReal4Num)
        UI.usForm.SetGrid(grdView, "TotalPriceProduct", "Total Harga [Barang]", 100, UI.usDefGrid.gReal2Num)
    ...
    Private Sub prvQuery()
        ...
        Try
            dtData = BL.Claim.ListDataDetailOutstandingConfirmationClaim(strParentID)
...
#Region "Form Handle"
    ...
    Private Sub frmTraConfirmationClaimOutstandingClaimItem_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmTraConfirmationClaimOutstandingClaimItem_Load(sender As Object, e As EventArgs) Handles MyBase.Load
