Public Class frmTraClaimDetItem
...
#End Region
    ...
    Private Sub prvChooseItem()
        ...
        '    .pubOrderRequestID = strReferencesID
        '    .pubCS = clsCS
...
#Region "Form Handle"
    ...
    Private Sub frmTraClaimDetItem_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmTraClaimDetItem_Load(sender As Object, e As EventArgs) Handles MyBase.Load
