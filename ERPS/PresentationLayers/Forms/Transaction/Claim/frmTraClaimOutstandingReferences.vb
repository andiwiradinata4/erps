Public Class frmTraClaimOutstandingReferences

#Region "Properties"

    Private frmParent As frmTraClaimDet
...
#End Region
    ...
    Private Sub prvSetGrid()
        ...
        UI.usForm.SetGrid(grdView, "ReferencesNumber", "Nomor", 100, UI.usDefGrid.gString)
    ...
    Private Sub prvQuery()
        ...
        Try
            If intClaimType = VO.Claim.ClaimTypeValue.Receive Then
                dtData = BL.Receive.ListDataOutstandingClaim(clsCS.CompanyID, clsCS.ProgramID, intBPID)
            ElseIf intClaimType = VO.Claim.ClaimTypeValue.Sales Then
                dtData = BL.SalesContract.ListDataOutstandingClaim(clsCS.CompanyID, clsCS.ProgramID, intBPID)
            End If
...
#Region "Form Handle"
    ...
    Private Sub frmTraClaimOutstandingReferences_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmTraClaimOutstandingReferences_Load(sender As Object, e As EventArgs) Handles MyBase.Load
