...
Public Class frmTraClaimDet

#Region "Property"

    Private intClaimType As VO.Claim.ClaimTypeValue
    Private frmParent As frmTraClaim
    Private clsData As VO.Claim
...
#End Region
    ...
    Private Sub prvSave()
        ...
        Dim listDetail As New List(Of VO.ClaimDet)
        For Each dr As DataRow In dtItem.Rows
            listDetail.Add(New ERPSLib.VO.ClaimDet With
                           {
                               .ReferencesDetailID = dr.Item("ReferencesDetailID"),
        ...
        clsData.ClaimNumber = txtClaimNumber.Text.Trim
        clsData.ClaimDate = dtpClaimDate.Value.Date
        ...
        Try
            ...
            UI.usForm.frmMessageBox("Data berhasil disimpan. " & vbCrLf & "Nomor : " & strClaimNumber)
            pgMain.Value = 80
            frmParent.pubRefresh(strClaimNumber)
            If pubIsNew Then
                prvQueryItem()
                prvQueryHistory()
                prvClear()
    ...
    Private Sub prvChooseReferences()
        Dim frmDetail As New frmTraClaimOutstandingReferences
        With frmDetail
            .pubCS = pubCS
            .pubBPID = intBPID
            ...
            If .pubIsLookupGet Then
                ...
                txtReferencesNumber.Text = .pubLUdtRow.Item("ReferencesNumber")
                bolIsUseSubItem = 0
    ...
    Private Sub prvSetupTools()
        ...
        btnReferences.Enabled = bolEnabled
    End Sub
...
#Region "Item Handle"
    ...
    Private Sub prvQueryItem()
        ...
        pgMain.Value = 30
        Try
            dtItem = BL.Claim.ListDataDetail(pubID.Trim)
            grdItem.DataSource = dtItem
            prvSumGrid()
            grdItemView.BestFitColumns()
            prvSetupTools()
...
#Region "History Handle"
    ...
    Private Sub prvQueryHistory()
        ...
        pgMain.Value = 30
        Try
            grdStatus.DataSource = BL.Claim.ListDataStatus(pubID.Trim)
        Catch ex As Exception
            UI.usForm.frmMessageBox(ex.Message)
        Finally
            Me.Cursor = Cursors.Default
...
#Region "Form Handle"
    ...
    Private Sub frmTraClaimDet_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmTraClaimDet_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If intClaimType = VO.Claim.ClaimTypeValue.Receive Then
            lblReferencesNumber.Text = "No. Penerimaan"
            lblBPName.Text = "Pemasok"
        ElseIf intClaimType = VO.Claim.ClaimTypeValue.Sales Then
            lblReferencesNumber.Text = "No. Kontrak Penjualan"
