Public Class frmTraReceiveDetOutstandingContract
...
#Region "Form Handle"
    ...
    Private Sub frmTraReceiveDetOutstandingContract_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmTraReceiveDetOutstandingContract_Load(sender As Object, e As EventArgs) Handles MyBase.Load
