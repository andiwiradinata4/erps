...
#Region "Property"
    ...
    Private frmParent As frmTraSalesContractDetItemCO
...
#Region "Form Handle"
    ...
    Private Sub frmTraConfirmationOrderOutstandingSalesContract_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmTraConfirmationOrderOutstandingSalesContract_Load(sender As Object, e As EventArgs) Handles MyBase.Load
