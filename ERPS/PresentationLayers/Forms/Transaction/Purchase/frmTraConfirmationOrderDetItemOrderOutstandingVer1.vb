...
Public Class frmTraConfirmationOrderDetItemOrderOutstandingVer1
...
#End Region
    ...
    Private Sub prvQuery()
        ...
        Try
            Dim dtData As DataTable = BL.PurchaseOrder.ListDataDetailOutstandingConfirmationOrder(clsCS.ProgramID, clsCS.CompanyID, intBPID)
...
#Region "Form Handle"
    ...
    Private Sub frmTraConfirmationOrderDetItemOrderOutstandingVer1_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmTraConfirmationOrderDetItemOrderOutstandingVer1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
