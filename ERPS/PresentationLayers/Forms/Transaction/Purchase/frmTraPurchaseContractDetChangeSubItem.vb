Public Class frmTraPurchaseContractDetChangeSubItem
...
#End Region
    ...
    Private Sub prvSave()
        ...
        Try
            BL.PurchaseContract.ChangeItemIDDetail(strID, intItemIDOld, intItemIDNew)
...
#Region "Form Handle"
    ...
    Private Sub frmTraPurchaseContractDetChangeSubItem_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmTraPurchaseContractDetChangeSubItem_Load(sender As Object, e As EventArgs) Handles MyBase.Load
