...
Public Class frmTraPurchaseOrderTransportDetItemOutstanding

#Region "Property"

    Private intPos As Integer = 0
    Private frmParent As frmTraPurchaseOrderTransportDetItem
...
#End Region
    ...
    Private Sub prvSetGrid()
        ...
        UI.usForm.SetGrid(grdView, "SCNumber", "Nomor Kontrak", 100, UI.usDefGrid.gString, False)
    ...
    Private Sub prvQuery()
        ...
        Try
            Dim dtData As DataTable = BL.SalesContract.ListDataDetailOutstandingTransport(clsCS.ProgramID, clsCS.CompanyID, strSCID)
            For Each drParent As DataRow In pubParentItem.Rows
                For Each dr As DataRow In dtData.Rows
                    If dr.Item("ID") = drParent.Item("SCDetailID") Then dr.Delete()
                Next
...
#Region "Form Handle"
    ...
    Private Sub frmTraSalesOrderTransportDetItemOutstanding_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmTraSalesOrderTransportDetItemOutstanding_Load(sender As Object, e As EventArgs) Handles MyBase.Load
