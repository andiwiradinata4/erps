...
Public Class frmTraPurchaseOrderOutstandingForCutting
...
#End Region
    ...
    Private Sub prvQuery()
        ...
        Try
            dtData = BL.PurchaseOrder.ListDataOutstandingForCutting(clsCS.ProgramID, clsCS.CompanyID, dtpDateFrom.Value.Date, dtpDateTo.Value.Date, cboStatus.SelectedValue)
...
#Region "Form Handle"
    ...
    Private Sub frmTraPurchaseOrderOutstandingForCutting_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmTraPurchaseOrderOutstandingForCutting_Load(sender As Object, e As EventArgs) Handles MyBase.Load
