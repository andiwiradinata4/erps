...
Public Class frmTraPurchaseOrderCuttingDetItemResultOustandingCutting

#Region "Properties"

    Private frmParent As frmTraCuttingDetItemResult
...
#End Region
    ...
    Private Sub prvSetGrid()
        ...
        UI.usForm.SetGrid(grdView, "PODetailResultID", "PODetailResultID", 100, UI.usDefGrid.gString, False)
...
#Region "Form Handle"
    ...
    Private Sub frmTraPurchaseOrderCuttingDetItemResultOustandingCutting_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmTraPurchaseOrderCuttingDetItemResultOustandingCutting_Load(sender As Object, e As EventArgs) Handles MyBase.Load
