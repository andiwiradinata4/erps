Public Class frmTraPurchaseContractFranco
    ...
    Private Sub prvSetGrid()
        UI.usForm.SetGrid(grdView, "Franco", "Syarat Penyerahan", 1000, UI.usDefGrid.gString)
    End Sub
    ...
    Private Sub prvQuery()
        Try
            grdMain.DataSource = BL.PurchaseContract.ListDataFranco
...
#Region "Form Handle"
    ...
    Private Sub frmTraPurchaseContractFranco_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmTraPurchaseContractFranco_Load(sender As Object, e As EventArgs) Handles MyBase.Load
