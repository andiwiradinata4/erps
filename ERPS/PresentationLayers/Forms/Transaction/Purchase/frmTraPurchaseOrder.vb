...
Public Class frmTraPurchaseOrder
    ...
    Private Sub prvSetGrid()
        ...
        UI.usForm.SetGrid(grdView, "OrderRequestID", "No. Permintaan", 100, UI.usDefGrid.gString)
        ...
        UI.usForm.SetGrid(grdView, "DeliveryPeriodFrom", "Periode Dari", 100, UI.usDefGrid.gDateMonth)
        ...
        UI.usForm.SetGrid(grdView, "TotalDPP", "[Pesanan] Total DPP", 100, UI.usDefGrid.gReal2Num)
        UI.usForm.SetGrid(grdView, "TotalPPN", "[Pesanan] Total PPN", 100, UI.usDefGrid.gReal2Num)
        UI.usForm.SetGrid(grdView, "TotalPPH", "[Pesanan] Total PPh", 100, UI.usDefGrid.gReal2Num)
        UI.usForm.SetGrid(grdView, "GrandTotal", "[Pesanan] Grand Total", 100, UI.usDefGrid.gReal2Num)
        UI.usForm.SetGrid(grdView, "RoundingManual", "RoundingManual", 100, UI.usDefGrid.gReal2Num, False)
        UI.usForm.SetGrid(grdView, "TotalInternalDPP", "[Permintaan] Total DPP", 100, UI.usDefGrid.gReal2Num)
        UI.usForm.SetGrid(grdView, "TotalInternalPPN", "[Permintaan] Total PPN", 100, UI.usDefGrid.gReal2Num)
        UI.usForm.SetGrid(grdView, "TotalInternalPPH", "[Permintaan] Total PPh", 100, UI.usDefGrid.gReal2Num)
        UI.usForm.SetGrid(grdView, "GrandTotalInternal", "[Permintaan] Grand Total", 100, UI.usDefGrid.gReal2Num)
