...
Public Class frmTraConfirmationOrderOutstandingSalesContractSubItemVer1

#Region "Property"

    Private intPos As Integer = 0
    Private frmParent As frmTraSalesContractDetItemCOSubVer1
    Private strParentID As String = ""
    Private clsCS As VO.CS
    Public pubLUdtRow As DataRow
    Public pubIsLookUpGet As Boolean = False
    Public pubParentSubItem As New DataTable
...
#End Region
    ...
    Private Sub prvSetGrid()
        ...
        UI.usForm.SetGrid(grdView, "CONumber", "Nomor Konfirmasi", 100, UI.usDefGrid.gString, False)
    ...
    Private Sub prvQuery()
        ...
        Try
            Dim dtData As DataTable = BL.ConfirmationOrder.ListDataDetailOutstandingSalesContract(clsCS.ProgramID, clsCS.CompanyID, strParentID)
            For Each drParent As DataRow In pubParentSubItem.Rows
...
#Region "Form Handle"
    ...
    Private Sub frmTraConfirmationOrderOutstandingSalesContractSubItemVer1_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmTraConfirmationOrderOutstandingSalesContractSubItemVer1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
