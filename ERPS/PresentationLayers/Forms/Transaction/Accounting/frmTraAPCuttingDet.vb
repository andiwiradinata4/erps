...
Public Class frmTraAPCuttingDet
...
#End Region
    ...
    Private Sub prvFillForm()
        ...
        Try
            ...
            Else
                ...
                txtPPH.Value = clsData.PPHPercentage
    ...
    Private Sub prvQueryItem()
        Try
            ...
            Me.Cursor = Cursors.WaitCursor
            If pubIsNew Then
                dtItem = BL.AccountPayable.ListDataDetailItemCuttingReceiveWithOutstandingVer00(pubCS.CompanyID, pubCS.ProgramID, intBPID, strID)
            Else
    ...
    Private Sub prvSumGrid()
        ...
        Dim SumMaxPaymentAmount As New GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Sum, "MaxPaymentAmount", "Total Maksimal Tagihan: {0:#,##0.00}")
        ...
        If grdItemView.Columns("MaxPaymentAmount").SummaryText.Trim = "" Then
            grdItemView.Columns("MaxPaymentAmount").Summary.Add(SumMaxPaymentAmount)
        End If
    ...
    Private Sub prvRecalculateItem()
        With grdItemView
            For i As Integer = 0 To .RowCount - 1
                If .GetRowCellValue(i, "Pick") Then
...
#Region "Form Handle"
    ...
    Private Sub frmTraAPCuttingDet_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmTraAPCuttingDet_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        With grdItemView
            ...
            If col.Name = "Amount" Or col.Name = "PPN" Or col.Name = "PPH" Then
                ...
                Else
                    ...
                    .UpdateCurrentRow()
                    If col.Name = "Amount" Then prvRecalculateItem()
                    prvCalculate()
                End If
