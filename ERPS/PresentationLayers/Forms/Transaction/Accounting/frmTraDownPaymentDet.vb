...
#End Region
    ...
    Private Sub prvFillForm()
        ...
        Try
            ...
            Else
                ...
                clsData = BL.DownPayment.GetDetail(strID, enumDPType)
                txtDPNumber.Text = clsData.DPNumber
    ...
    Private Sub prvSave()
        ...
        clsData.DPNumber = txtDPNumber.Text.Trim
        ...
        clsData.DPDate = dtpDPDate.Value.Date
        ...
        Try
            Dim strDPNumber As String = BL.DownPayment.SaveData(bolIsNew, clsData)
