...
Public Class frmTraJournalAutoGenerate
    ...
    Private Const _
       cDetail As Byte = 0, cSep1 As Byte = 1, cExportExcel As Byte = 2, cSep2 As Byte = 3, cRefresh As Byte = 4, cClose As Byte = 5
    ...
    Private Sub prvQuery()
        ...
        pgMain.Value = 30
        Try
            dtData = BL.Journal.ListData(intCompanyID, ERPSLib.UI.usUserApp.ProgramID, dtpDateFrom.Value.Date, dtpDateTo.Value.Date, cboStatus.SelectedValue, "", True)
...
#Region "Form Handle"
    ...
    Private Sub frmTraJournalAutoGenerate_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmTraJournalAutoGenerate_Load(sender As Object, e As EventArgs) Handles MyBase.Load
