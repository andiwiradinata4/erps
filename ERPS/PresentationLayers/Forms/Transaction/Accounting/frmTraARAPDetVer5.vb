...
Public Class frmTraARAPDetVer5
...
#End Region
    ...
    Private Sub prvSave()
        ...
        clsDetail.InvoiceNumberBP = txtInvoiceNumberBP.Text.Trim
        clsDetail.ReceiveDate = dtpReceiveDate.Value.Date
        clsDetail.InvoiceDate = dtpInvoiceDate.Value.Date
...
#Region "Form Handle"
    ...
    Private Sub frmTraARAPDetVer5_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmTraARAPDetVer5_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        prvGetModuleID()
