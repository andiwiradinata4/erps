Public Class frmTraAccountSetTaxInvoiceNumber

    Private bolSave As Boolean = False
    Private strTaxInvoiceNumber As String = ""
    ...
    Private Sub prvSave()
        ...
        bolSave = True
        strTaxInvoiceNumber = txtTaxInvoiceNumber.Text.Trim
...
#Region "Form Handle"
    ...
    Private Sub frmTraAccountSetTaxInvoiceNumber_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
