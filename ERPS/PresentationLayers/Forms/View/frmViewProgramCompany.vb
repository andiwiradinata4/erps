Public Class frmViewProgramCompany
    ...
    Private Sub prvQuery()
        Try
            ...
            dtData = dsHelper.SelectGroupByInto("Program", ERPSLib.UI.usUserApp.AccessList, "ProgramID,ProgramName,CompanyID,CompanyName,Address,CompanyInitial", "", "ProgramID,ProgramName,CompanyID,CompanyName,Address,CompanyInitial")
