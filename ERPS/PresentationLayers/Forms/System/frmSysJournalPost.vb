...
#End Region
    ...
    Private Sub prvUserAccess()
        ToolBar.Buttons(cSave).Visible = BL.UserAccess.IsCanAccess(ERPSLib.UI.usUserApp.UserID, ERPSLib.UI.usUserApp.ProgramID, VO.Modules.Value.SetupPostingJournalTransaction, VO.Access.Value.EditAccess)
    End Sub
