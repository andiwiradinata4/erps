Public Class frmRptSalesConfirmationOrderReportVer00
...
#End Region
    ...
    Private Sub prvPreview()
        ...
        Dim dtData As DataTable = BL.Reports.SalesConfirmationReport(ERPSLib.UI.usUserApp.ProgramID, ERPSLib.UI.usUserApp.CompanyID, dtpDateFrom.Value.Date, dtpDateTo.Value.Date, intBPID, cboItemType.SelectedValue)
        ...
        If Not chkIsShowSize.Checked Then
            ...
            Dim dtGroup As DataTable = dsHelper.SelectGroupByInto("DataGroup", dtData, "No, CODate, PONumber, OrderNumber, ItemSpec, ItemType, UnitPrice, SUM(TotalWeight) TotalWeight, SUM(TotalIncPPN) TotalIncPPN", "", "No, CODate, PONumber, OrderNumber, ItemSpec, ItemType, UnitPrice")
            dtData = dtGroup
        End If
        ...
        Try
            Dim crReport As New rptSalesConfirmationOrderReportVer00
...
#Region "Form Handle"
    ...
    Private Sub frmRptPOReport_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.Escape Then
            If UI.usForm.frmAskQuestion("Tutup form?") Then Me.Close()
        End If
    End Sub

    Private Sub frmRptPOReport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
