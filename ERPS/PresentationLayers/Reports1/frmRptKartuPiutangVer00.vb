...
#End Region
    ...
    Private Function prvGetFirstBalance(ByVal intBPID As Integer) As Decimal
        ...
        Dim dtData As DataTable = BL.Reports.KartuPiutangVer01Report(New DateTime(1900, 1, 1), dtpDateFrom.Value.Date.AddDays(-1), ERPSLib.UI.usUserApp.ProgramID, ERPSLib.UI.usUserApp.CompanyID, intBPID)
        With dtData
            ...
            For i As Integer = 0 To .Rows.Count - 1
                ...
                If i = 0 Then
                    .Rows(i).Item("BalanceAmount") = 0 + .Rows(i).Item("DebitAmount") - .Rows(i).Item("CreditAmount")
                Else
    ...
    Private Function prvCollectDataVer00(ByVal drPick() As DataRow) As DataTable
        ...
        Try
            ...
            For Each dr As DataRow In drPick
                ...
                dtCurrent = BL.Reports.KartuPiutangVer01Report(dtpDateFrom.Value.Date, dtpDateTo.Value.Date, ERPSLib.UI.usUserApp.ProgramID, ERPSLib.UI.usUserApp.CompanyID, dr.Item("ID"))
                With dtCurrent
                    prvSetProgressBar(.Rows.Count)
                    For i As Integer = 0 To .Rows.Count - 1
                        .Rows(i).BeginEdit()
    ...
    Private Sub prvPreview()
        ...
        Try
            ...
            With crReport
                ...
                .Parameters.Item("ReportTitle").Value = "KARTU PIUTANG"
